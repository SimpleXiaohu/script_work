                ...
                jalangiLabel0:
                    while (true) {
                        try {
                            ...
                            var regex = J$.X1(25, J$.W(17, 'regex', J$.T(9, /^[-|\+]?[0-9]{1,3}(\,[0-9]{3})*$|^[-|\+]?[0-9]+$/, 14, false), regex, 1));
