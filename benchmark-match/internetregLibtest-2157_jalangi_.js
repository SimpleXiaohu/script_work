                ...
                jalangiLabel0:
                    while (true) {
                        try {
                            ...
                            var regex = J$.X1(25, J$.W(17, 'regex', J$.T(9, /(^(p[\s|\.|,]*|\n^post[\s|\.]*)(o[\s|\.|,]*|\noffice[\s|\.]*))|\n(^box[.|\s]*\d+)/, 14, false), regex, 1));
