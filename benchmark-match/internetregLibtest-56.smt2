...
(assert (str.in.re var0 (re.++ (re.*? re.allchar) (re.++ (re.++ (str.to.re "h") (re.++ (str.to.re "t") (re.++ (str.to.re "t") (re.++ (str.to.re "p") (re.++ (str.to.re ":") (re.++ (str.to.re "/") (re.++ (str.to.re "/") (re.++ (re.union (re.++ (str.to.re "") ((_ re.capture 1) (re.++ (str.to.re "w") (re.++ (str.to.re "w") (re.++ (str.to.re "w") (str.to.re ".")))))) (str.to.re "")) (re.++ ((_ re.capture 2) (re.+ (re.diff (re.range "\x01" "\xff") (str.to.re ".")))) (re.++ (str.to.re ".") (re.++ (str.to.re "c") (re.++ (str.to.re "o") (re.++ (str.to.re "m") (str.to.re " ")))))))))))))) re.all))))	; match!==null
