                ...
                jalangiLabel0:
                    while (true) {
                        try {
                            ...
                            var regex = J$.X1(25, J$.W(17, 'regex', J$.T(9, /^\s*(http[s]*\:\/\/)?([wwW]{3}\.)+[a-zA-Z0-9]+\.[a-zA-Z]{2,3}.*$|^http[s]*\:\/\/[^w]{3}[a-zA-Z0-9]+\.[a-zA-Z]{2,3}.*$|http[s]*\:\/\/[0-9]{2,3}\.[0-9]{2,3}\.[0-9]{2,3}\.[0-9]{2,3}.*$/, 14, false), regex, 1));
