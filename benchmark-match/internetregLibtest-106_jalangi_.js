                ...
                jalangiLabel0:
                    while (true) {
                        try {
                            ...
                            var regex = J$.X1(25, J$.W(17, 'regex', J$.T(9, /^\d{0,2}(\.\d{1,4})? *%?$/, 14, false), regex, 1));
