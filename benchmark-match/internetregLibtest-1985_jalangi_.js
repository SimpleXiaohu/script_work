                ...
                jalangiLabel0:
                    while (true) {
                        try {
                            ...
                            var regex = J$.X1(25, J$.W(17, 'regex', J$.T(9, /(jar:)?file:\/(([A-Z]:)?\/([A-Z0-9\*\()\+\-\&$#@_.!~\[\]\/])+)((\/[A-Z0-9_()\[\]\-=\+_~]+\.jar!)|([^!])(\/com\/regexlib\/example\/))/, 14, false), regex, 1));
