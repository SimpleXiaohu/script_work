...
(assert (= res ((_ str.extract 1) var0 (re.++ re.begin-anchor (re.union (re.++ (str.to.re "") (re.++ (re.opt? ((_ re.capture 1) (re.union (re.range "a" "z") (re.range "A" "Z")))) re.all)) (re.++ (str.to.re "") re.all))))))
