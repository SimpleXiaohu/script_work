...
(assert (= res ((_ str.extract 1) var0 (re.++ re.begin-anchor (re.union (re.++ (str.to.re "") (re.++ (re.*? ((_ re.capture 1) (re.union (re.++ (str.to.re "") (re.range "a" "z")) (str.to.re "")))) re.all)) (re.++ (str.to.re "") re.all))))))
