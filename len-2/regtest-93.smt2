...
(assert (str.in.re var0 (re.++ re.begin-anchor (re.++ (re.+? ((_ re.capture 1) ((_ re.loop 1 4) (re.range "a" "z")))) (re.++ (re.inter (re.diff (re.range "\x01" "\xff") (re.range "A" "Z")) (re.inter (re.diff (re.range "\x01" "\xff") (re.range "a" "z")) (re.diff (re.range "\x01" "\xff") (re.range "0" "9")))) re.all)))))
