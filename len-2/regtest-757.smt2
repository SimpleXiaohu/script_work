...
(assert (= res ((_ str.extract 1) var0 (re.++ re.begin-anchor (re.union (re.++ (str.to.re "") (re.++ ((_ re.loop? 1 4) ((_ re.capture 1) (re.opt? (re.range "a" "z")))) re.all)) (re.++ (str.to.re "") re.all))))))
