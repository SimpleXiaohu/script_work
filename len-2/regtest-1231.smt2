...
(assert (= res ((_ str.extract 1) var0 (re.++ re.begin-anchor (re.++ ((_ re.loop? 1 4) (re.union (re.++ (str.to.re "") ((_ re.capture 1) (re.union (re.range "a" "z") (re.range "A" "Z")))) (str.to.re ""))) re.all)))))
